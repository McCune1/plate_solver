#!/usr/bin/env python3
"""Score the Paper 4 3-D FE check of coupled n >= 1 roots. Gates fixed before any run.
...
DATE = "2026-09-23"
TARGETS = os.path.join(HERE, "targets_p4_3d_nge1_%s.json" % DATE)
...
AXI_E0_BAR = 0.0010
AXI_OC_SC = {"h112": 119.14314 / 118.81103 - 1.0,
             "h15": 127.80931 / 127.04679 - 1.0}
AXI_SPLIT_BAR = 0.03
ELASTIC_BAR = 0.010
...
def main(argv):
    ...
    print(text)
    out = os.path.join(directory, "score_p4_3d_nge1_%s.txt" % DATE)
