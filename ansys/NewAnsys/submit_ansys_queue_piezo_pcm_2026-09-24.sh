#!/bin/bash
#SBATCH --job-name=pcm
#SBATCH --output=ansys_queue_piezo_pcm_%j.out
#SBATCH --error=ansys_queue_piezo_pcm_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# Piezoelectric contour-mode (n = 0 radial) FE on the Paper 5 ring (2026-09-24).
# Pre-registration: Project Knowledge/CONTOUR_MODE_N0_DERIVATION_2026-09-24.md
# 12 axisymmetric PLANE223 decks: e31 {+4.1, -4.1} x {sc, oc modal, harm}
# x mesh {80x12, 160x24}.
...
#   ansys_pcm_*_2026-09-24.inp   (12 decks)
#   ansys_queue_manifest_piezo_pcm_2026-09-24.txt
#   submit_ansys_queue_piezo_pcm_2026-09-24.sh
#   targets_pcm_2026-09-24.json
#   score_pcm_fe_2026-09-24.py
#   build_pcm_decks_2026-09-24.py   (optional; needs the predictions JSON)
# then from that directory:
#   sbatch submit_ansys_queue_piezo_pcm_2026-09-24.sh
...
export MANIFEST=ansys_queue_manifest_piezo_pcm_2026-09-24.txt
export STOP_ON_FAIL=0
bash run_ansys_queue.sh
echo "End: $(date)"
if [ -f score_pcm_fe_2026-09-24.py ]; then
  python3 score_pcm_fe_2026-09-24.py | tee score_pcm_fe_2026-09-24.txt || true
fi
