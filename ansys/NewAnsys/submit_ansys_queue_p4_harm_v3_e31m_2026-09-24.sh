#!/bin/bash
#SBATCH --job-name=p4_harm_v3
#SBATCH --output=ansys_queue_p4_harm_v3_e31m_%j.out
#SBATCH --error=ansys_queue_p4_harm_v3_e31m_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ONE deck: Paper 4 driven admittance at e31 = -4.1 with the sweep widened to
# 118.5-122.0 Hz so the admittance zero (~121.1 Hz) is inside it (LESSONS 18.245).
# PUSH: ansys_p4_harm_ff_y_v3_h112_e31m_2026-09-24.inp,
#       ansys_queue_manifest_p4_harm_v3_e31m_2026-09-24.txt, this script.
# Output to download: ansys_p4_harm_ff_y_v2_h112_sweep_e31m_v3.csv (+ the deck's _out.txt).
...
export MANIFEST=ansys_queue_manifest_p4_harm_v3_e31m_2026-09-24.txt
export STOP_ON_FAIL=0
bash run_ansys_queue.sh
echo "End: $(date)"
echo "Download: $(pwd)/ansys_p4_harm_ff_y_v2_h112_sweep_e31m_v3.csv and ansys_p4_harm_ff_y_v3_h112_e31m_2026-09-24_out.txt"
