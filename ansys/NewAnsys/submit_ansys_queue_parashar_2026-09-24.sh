#!/bin/bash
#SBATCH --job-name=parashar
#SBATCH --output=ansys_queue_parashar_%j.out
#SBATCH --error=ansys_queue_parashar_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# Phase B scout: independent axisymmetric FE of Parashar 2013 Tables 2/3,
# n = 0 column (radially poled PIC 255 annulus, SC).  6 PLANE223 decks.
...
#   ansys_parashar_*_2026-09-24.inp   (6 decks)
#   ansys_queue_manifest_parashar_2026-09-24.txt
#   submit_ansys_queue_parashar_2026-09-24.sh
#   targets_parashar_2026-09-24.json
#   score_parashar_fe_2026-09-24.py
#   build_parashar_decks_2026-09-24.py   (optional)
# then:  sbatch submit_ansys_queue_parashar_2026-09-24.sh
...
export MANIFEST=ansys_queue_manifest_parashar_2026-09-24.txt
export STOP_ON_FAIL=0
bash run_ansys_queue.sh
echo "End: $(date)"
if [ -f score_parashar_fe_2026-09-24.py ]; then
  python3 score_parashar_fe_2026-09-24.py | tee score_parashar_fe_2026-09-24.txt || true
fi
