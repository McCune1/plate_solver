#!/bin/bash
#SBATCH --job-name=p4_liudisk2
#SBATCH --output=ansys_queue_piezo_liudisk2_%j.out
#SBATCH --error=ansys_queue_piezo_liudisk2_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# Paper 4 lever 11 -- Liu 2002 solid-disk SC FE, v2 (free inner hole).
# Fixes job 2530987 (v1 inner UX=0 stiffened every n=1 mode by 2-7%).
...
#   ansys_p4_liudisk2_sc_C_2026-09-24.inp
#   ansys_p4_liudisk2_sc_S_2026-09-24.inp
#   ansys_queue_manifest_piezo_liudisk2_2026-09-24.txt
#   submit_ansys_queue_piezo_liudisk2_2026-09-24.sh
#   targets_liudisk2_2026-09-24.json
#   score_liudisk2_fe_2026-09-24.py
#   build_liu_disk_sc_decks_v2_2026-09-24.py   (optional; regenerates decks)
# then from that directory:
#   sbatch submit_ansys_queue_piezo_liudisk2_2026-09-24.sh
# after it ends:
#   python3 score_liudisk2_fe_2026-09-24.py | tee score_liudisk2_fe_2026-09-24.txt
# Two decks, ~25 s each on 8 cores in job 2530987.
...
export MANIFEST=ansys_queue_manifest_piezo_liudisk2_2026-09-24.txt
export STOP_ON_FAIL=0
bash run_ansys_queue.sh
echo "End: $(date)"
if [ -f score_liudisk2_fe_2026-09-24.py ]; then
  python3 score_liudisk2_fe_2026-09-24.py | tee score_liudisk2_fe_2026-09-24.txt || true
fi
