...
\section[Cubic consistency condition and the open-circuit-equals-short-circuit theorem]{Cubic consistency condition and the\\ open-circuit-equals-short-circuit theorem}
\label{sec:s1}
...
\texttt{Q\_segment}/\allowbreak\texttt{Y\_sense} return, per unit force,
$+\tfrac{4\pi}{3}H\Xi_{11}r_*\bar\phi'(r_*)$. That is
...
\textbf{Gates} (probe
\fn{probe\_piezo\_p5\_e15\_segment\_charge\_2026-09-24.py} at
...
$e_{31}$ from open-circuit flexure,'' unpublished manuscript (2026).
