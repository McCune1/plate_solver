"""e31 = -4.1 regeneration (2026-09-24, LESSONS Sec 18.246) of the Paper 4 figures
first made for the 2026-09-23 consistent-projection fix (Sec 18.231):
...
fa = s.oc_ff_bisect(750.0, 780.0, 0) / (2 * math.pi)
f = np.linspace(116.0, 122.5, 521)
...
ax.set_xlim(116.0, 122.5); ax.set_ylim(-8, 12)
...
d = json.load(open(os.environ.get("LEVER16_JSON", "piezo_p4_lever16_freq_noise_floor_results_e31m.json")))
