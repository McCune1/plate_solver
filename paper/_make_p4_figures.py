...
unc_sc = np.array([888.5, 293.8, 87.9])  # 2026-09-23 Sec 18.231 (duan: 730.8, 241.6, 72.3)
unc_oc = np.array([2.133, 1.479, 1.004])  # duan: 1.983, 1.335, 0.865
k2 = np.array([0.005573, 0.008054, 0.011912])  # duan: 0.005997, 0.008934, 0.013846
