#!/bin/bash
#SBATCH --job-name=p4_piezo_Echan
#SBATCH --output=piezo_p4_ff_E_channel_2026-09-16_%j.out
#SBATCH --error=piezo_p4_ff_E_channel_2026-09-16_%j.err
#SBATCH --ntasks=1
...
# Lever 4: host E from F-F elastic and F-F OC. From Paper4_Piezo/:
#   sbatch submit_piezo_p4_ff_E_channel_2026-09-16.sh
...
export PIEZO_DPS=40
if [ ! -f probe_piezo_p4_ff_E_channel_2026-09-16.py ]; then
...
python3 -u probe_piezo_p4_ff_E_channel_2026-09-16.py
echo "end=$(date)"
