...
Writes piezo_p4_ff_n0_overtones_wide_results.json -- does not
...
def main():
    ...
    for i in range(n_pair):
        ...
        try:
            ...
            g2 = ((1e-4 * w_oc / abs(dw_de)) / E31_TRUE * 100.0
    ...
    path = os.path.join(out_dir, "piezo_p4_ff_n0_overtones_wide_results.json")
