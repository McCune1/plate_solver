...
def main():
    ...
    for rel_prec in (1e-4, 1e-3):
        ...
        note("G2 @ %.4f%% freq: dE_hat=%.4f%% of E_true; "
             ...
             % (rel_prec * 100, dE_hat_prop / E_TRUE * 100,
                delta_e31_direct / E31_TRUE * 100,
                delta_e31_from_E / E31_TRUE * 100,
                delta_e31_total / E31_TRUE * 100))
    ...
    g_neg_pass = (delta_e31_neg_001 / E31_TRUE) >= 1.0
    note("G_neg propagated: 0.01%% freq -> %.2f%% of e31_true; 0.1%% freq -> "
         "%.2f%% (bar: >=100%% at 0.01%%) pass=%s"
         % (delta_e31_neg_001 / E31_TRUE * 100,
            delta_e31_neg_01 / E31_TRUE * 100, g_neg_pass))
    ...
    out_path = os.path.join(os.path.dirname(__file__) or ".",
                             "piezo_p4_sequential_e_e31_results.json")
    ...
    print("  E_hat rel_err=%.3e  sequential e31_hat rel_err=%.3e  "
          ...
          % (g0_E_rel, g0_e31_rel,
             ...
             delta_e31_neg_001 / E31_TRUE * 100), flush=True)
