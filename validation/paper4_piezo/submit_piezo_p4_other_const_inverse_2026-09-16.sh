#!/bin/bash
#SBATCH --job-name=p4_piezo_othinv
#SBATCH --output=piezo_p4_other_const_inverse_2026-09-16_%j.out
#SBATCH --error=piezo_p4_other_const_inverse_2026-09-16_%j.err
#SBATCH --ntasks=1
...
# Lever 3: X33 / nu / C11E inverses. From Paper4_Piezo/:
#   sbatch submit_piezo_p4_other_const_inverse_2026-09-16.sh
...
export PIEZO_DPS=40
if [ ! -f probe_piezo_p4_other_const_inverse_2026-09-16.py ]; then
...
python3 -u probe_piezo_p4_other_const_inverse_2026-09-16.py
echo "end=$(date)"
