# e31 = -4.1 COPY (LESSONS Sec 18.246) of probe_piezo_p4_lever16_freq_noise_floor_2026-09-16.py.
...
PUBLISHED_ANCHORS = {
    ...
    # e31=-4.1 re-anchor (2026-09-24): cross-probe values from
    # probe_piezo_p4_ff_open_circuit_e31m (G2 0.8701%) and
    # probe_piezo_p4_cf_mixed_edge_e31m (G2 0.9282%); +4.1 were 2.13/2.28, 21.3/22.8.
    1e-4: {"ff": 0.870, "cf": 0.928},
    1e-3: {"ff": 8.70, "cf": 9.28},
}
...
def main():
    ...
    out_path = os.path.join(os.path.dirname(__file__) or ".",
                            "piezo_p4_lever16_freq_noise_floor_results_e31m.json")
