# e31 = -4.1 COPY (LESSONS Sec 18.246) of probe_piezo_p4_ff_open_circuit_2026-09-16.py.
...
def main():
    ...
    g_stiffen = (omega_oc > omega_el) and (0.01448 < drel < 0.0362)
    ...
    out_path = os.path.join(os.path.dirname(__file__) or ".",
                            "piezo_p4_ff_open_circuit_results_e31m.json")
