# e31 = -4.1 COPY (LESSONS Sec 18.246) of probe_piezo_p4_ff_n0_overtones_2026-09-16.py.
...
def main():
    ...
    for i in range(n_pair):
        ...
        g2 = (1e-4 * w_oc / abs(dw_de)) / abs(E31_TRUE) * 100.0 if dw_de else float("inf")
        row = dict(
    ...
    path = os.path.join(out_dir, "piezo_p4_ff_n0_overtones_results_e31m.json")
