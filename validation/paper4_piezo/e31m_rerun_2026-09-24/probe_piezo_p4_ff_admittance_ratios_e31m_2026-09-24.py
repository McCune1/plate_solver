# e31 = -4.1 COPY (LESSONS Sec 18.246) of probe_piezo_p4_ff_admittance_ratios_2026-09-16.py.
...
# old (h+h1) duan anchors in the trailing comments.
    # e31 = -4.1 anchors: free-vibration oc_ff_bisect and k2 = 1-(el/oc)^2 from
    # probe_piezo_p4_h1_ratio_sweep_e31m_2026-09-24 (+4.1 anchors were
    # 767.2091198988, 0.00805 and 805.1123631872, 0.01191).
    ("1/8", 1.0 / 8, 764.1133267197, 785.3273523727981, 0.053296243028065016),
    ("1/5", 1.0 / 5, 800.3026922029, 832.4387160506383, 0.07571902388771745),
]
...
def main():
    ...
    json_path = os.path.join(out_dir, "piezo_p4_ff_admittance_ratios_results_e31m.json")
    with open(json_path, "w") as f:
        json.dump(results, f, indent=2)
    csv_path = os.path.join(out_dir, "piezo_p4_ff_admittance_ratios_e31m.csv")
