# e31 = -4.1 COPY (LESSONS Sec 18.246) of probe_piezo_p5_yomega_sense_2026-09-20.py.
...
OMEGA_NEAR_POLE = 521.5
R_F = 0.35
R_STAR = 0.30
CP_FF_LO, CP_FF_HI = 505.0, 535.0    # bracket for the known F-F SC fundamental
...
def main():
    ...
    out_path = os.path.join(os.path.dirname(__file__) or ".",
                             "piezo_p5_yomega_sense_results_e31m.json")
