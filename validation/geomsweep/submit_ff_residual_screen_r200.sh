#!/bin/bash
#SBATCH --job-name=ff_residual_screen_r200
#SBATCH --output=ff_residual_screen_r200_%j.out
#SBATCH --error=ff_residual_screen_r200_%j.err
#SBATCH --nodes=1
...
# Runs probe_ff_residual_screen_geomsweep.py for RATIO_TAG=r200 (54
...
# submit_ff_residual_screen_r200.sh`).
