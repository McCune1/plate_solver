#!/bin/bash
#SBATCH --job-name=ff_r200a50_ip
#SBATCH --output=ff_r200a50_nu030_ip_%j.out
#SBATCH --error=ff_r200a50_nu030_ip_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# Rank 16 IP capture: r0/2b=2.0, 2Theta/pi=0.5, nu=0.30.
# SIGMIN_LOCAL_SPLIT is NOT set (job 2410036).
...
echo "Job $SLURM_JOB_ID on $(hostname): PART=$PART (IP), N_WORKERS=$N_WORKERS"
echo "Start: $(date)"
